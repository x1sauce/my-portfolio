...
// import myCarouselImage from '../images/myCarouselImage.png';
...
const Portfolio = () => {
    return (
        <section className="portfolio-section" id="Portfolio" >
            <div className="portfolio-section-container-group">
                <div className="portfolio-container">
                    <p className="portfolio-container-title">Recent Projects</p>
                    <h2 className="portfolio-container-heading">My Portfolio</h2>
                </div>
                <div className="portfolio-section-container-button">
            ...
            <div className="portfolio-section-card-group">
                {data.portfolio.map((item) => (
                    <div key={item.id} className="portfolio-section-card">
                        ...
                        <div className="portfolio-section-card-content">
                            <div className="portfolio-section-card-title">
                                <h3>{item.title}</h3>
                            </div>
                            <div className="portfolio-section-card-description">
